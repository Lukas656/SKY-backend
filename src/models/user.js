...
async function updateById(id, newData) {
	...
	result = await repository.updateOne(COLLETION_USUARIO, {id: id },  { $set: { nome: newData.nome, senha: newData.senha, telefones: [{ numero: newData.telefones[0].numero, ddd: newData.telefones[0].ddd }], data_atualizacao: ultima_atualizacao } });
